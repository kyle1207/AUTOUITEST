...
class TestAddUserAcDevOpGroupMgmt:
    ...
    def user_ac_logout(self):
        element = self.role_pageroleMgmt.element_find(role_Mgmt.roleMgmt_ac_1)
    ...
    def test_user_role_judge_datacollector(self):
        self.user_ac_judge_datacollector()
    ...
    def delete_user_group_ac_devOper_dev_download(self):
        ...
        self.pageadminMgmt.delete_group(groupNameList[4][0])
        self.pageadminMgmt.delete_group(groupNameList[4][1])
        self.pageadminMgmt.delete_group(groupNameList[4][2])
    ...
    def user_group_assign(self):
        self.logger.info("数采运营+开发运营+普通用户")
        adduser = GetYaml("user_Mgmt.yaml").find_userMgmt()
        groupNameList = GetYaml("user_Mgmt.yaml").get_groupNames_Mgmt()
        self.assign_usergroup(adduser, groupNameList[4])
    ...
    def user_ac_judge_datacollector(self):
        self.role_pageroleMgmt.page_ac_list()
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_list)[0] == '灵活采集'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_list)[1] == '事件采集'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_list)[2] == '资源监控'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_list)[3] == '信号查询'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_list)[4] == '版本查询'
        except Exception as e:
            self.logger.error("未找到版本查询菜单")
            self.role_pageroleMgmt.insert_image()
            raise

        self.role_pageroleMgmt.page_ac_main_1()
        try:
        ...
        self.role_pageroleMgmt.page_ac_main_2()
        try:
        ...
        self.role_pageroleMgmt.page_ac_main_3()
        try:
        ...
        self.role_pageroleMgmt.page_ac_main_4()
        try:
        ...
        self.role_pageroleMgmt.page_ac_main_5()
        try:
