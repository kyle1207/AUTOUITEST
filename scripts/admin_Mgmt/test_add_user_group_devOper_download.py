...
class TestAddUserOpDownGroupMgmt:
    ...
    def test_delete_user_group_devOper_download(self):
        self.delete_user_group_devOper_download()

    def delete_user_group_devOper_download(self):
        ...
        self.pageadminMgmt.delete_group(groupNameList[1][0])
        self.pageadminMgmt.delete_group(groupNameList[1][1])
    ...
    def user_download_judge_datacollector(self):
        self.role_pageroleMgmt.page_download_list()
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_download_list)[0] == '全量下载'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_download_list)[1] == '数采下载'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_download_list)[2] == '事件下载'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_download_list)[3] == '信号查询'
        except Exception as e:
        ...
        try:
            assert self.role_pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_download_list)[4] == '版本查询'
        except Exception as e:
            self.logger.error("未找到版本查询菜单")
            self.role_pageroleMgmt.insert_image()
            raise

        self.role_pageroleMgmt.page_download_main_1()
        try:
        ...
        self.role_pageroleMgmt.page_download_main_2()
        try:
        ...
        self.role_pageroleMgmt.page_download_main_3()
        try:
        ...
        self.role_pageroleMgmt.page_download_main_4()
        try:
        ...
        self.role_pageroleMgmt.page_download_main_5()
        try:
