...
class TestRoleDevMgmt:
    ...
    def test_dev_role(self):
        self.pageroleMgmt.page_dev_list()
        try:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_dev_list)[7] == '信号查询'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_dev_list)[8] == '版本查询'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_dev_list)[9] == '参数配置'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_dev_list)[10] == '事件历史'
        except Exception as e:
            self.logger.error("未找到事件历史菜单")
            self.pageroleMgmt.insert_image()
            raise

        self.pageroleMgmt.page_dev_main_1()
        try:
        ...
        self.pageroleMgmt.page_dev_main_2()
        try:
        ...
        self.pageroleMgmt.page_dev_main_3()
        try:
        ...
        self.pageroleMgmt.page_dev_main_4()
        try:
        ...
        self.pageroleMgmt.page_dev_main_5()
        try:
        ...
        self.pageroleMgmt.page_dev_main_6()
        try:
        ...
        self.pageroleMgmt.page_dev_main_7()
        try:
        ...
        self.pageroleMgmt.page_dev_main_8()
        try:
        ...
        self.pageroleMgmt.page_dev_main_9()
        try:
        ...
        self.pageroleMgmt.page_dev_main_10()
        try:
        ...
        self.pageroleMgmt.page_dev_main_11()
        try:
