...
class TestRoleDevMgmt:
    ...
    def test_ac_download_role(self):
        self.pageroleMgmt.page_ac_download_list()
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[0] == '灵活采集'
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[1] == '事件采集'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[2] == '全量下载'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[3] == '数采下载'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[4] == '事件下载'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[5] == '资源监控'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[6] == '信号查询'
        except Exception as e:
        ...
        try:
            assert self.pageroleMgmt.elements_get_text(role_Mgmt.roleMgmt_ac_download_list)[7] == '版本查询'
        except Exception as e:
            self.logger.error("未找到版本查询菜单")
            self.pageroleMgmt.insert_image()
            raise

        self.pageroleMgmt.page_ac_download_main_1()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_2()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_3()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_4()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_5()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_6()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_7()
        try:
        ...
        self.pageroleMgmt.page_ac_download_main_8()
        try:
